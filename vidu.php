      ...
      <div class="col-md-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="product.php?id=<?php echo $item['productID'] ?>" class="btn btn-outline-danger">Delete</a>
            </div>
          </div>
        </div>
 		 <?php
 		 ...
 		 <?php 
 		  	...
 		  	foreach( $_SESSION['cart'] as $item ){
 		  	 ...
 		  	 <div class="card card-body" style="margin-top: 20px;">
 		  	 	<h3 class="cart-header text-center red">Total: <?php echo number_format($tong)?> $</h3>
 		  	 	<?php if(!$tong == 0){
 		  	 	 ?>
